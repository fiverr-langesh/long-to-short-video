      ...
      <div className=' flex items-center justify-between'>
          <h1 className=' text-4xl font-bold text-stone-50'>LOGO</h1>
          {
            ...
            <div className=' flex items-center gap-5'>
              <button className=' bg-gray-600 py-1 px-3 rounded font-medium text-slate-50'>Upgrade</button>
              <div className=' flex flex-col gap-1'>
                <div class=" w-52 bg-gray-600 rounded-full h-2.5 dark:bg-gray-700">
                  <div class=" bg-emerald-400 h-2.5 rounded-full w-[45%]"></div>
                </div>
                <p className=' text-stone-50 font-semibold text-xs'>31m / 1h 30m used</p>
              </div>
              <div className=' h-fit relative'>
                <div className=' cursor-pointer' onClick={()=>setShowOptions(!showOptions)}><BiUserCircle color='white' size={50} /></div>
                <div className={`${showOptions ? "flex" : "hidden"} flex-col justify-center items-start gap-3 border rounded bg-slate-800 text-slate-50 font-medium absolute w-52 right-0 py-4 px-2 `}>
